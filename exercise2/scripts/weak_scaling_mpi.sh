...
#SBATCH --output=/u/dssc/vnigam/HPC/exercise2/results/mandelbrot_mpi_weak_scaling_output.txt
#SBATCH --error=/u/dssc/vnigam/HPC/exercise2/results/mandelbrot_mpi_weak_scaling_error.txt
#SBATCH --nodes=2
...
# Create results file
results_file="/u/dssc/vnigam/HPC/exercise2/results/mpi_weak_scaling.csv"
